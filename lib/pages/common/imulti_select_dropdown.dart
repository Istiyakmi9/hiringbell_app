library imulti_select_dropdown;

import 'dart:async';
import 'package:flutter/material.dart';

export 'imulti_select_dropdown.dart';

part 'model/imulti_select_dropdown_decoration.dart';

part 'model/value_notifier_list.dart';

part 'model/search_field_decoration.dart';

part 'model/list_item_decoration.dart';
part 'model/imulti_select_list_filter.dart';

part 'utils/builders.dart';

part 'widget/dropdown_field.dart';
part 'widget/overlay/dropdown_overlay.dart';
part 'widget/animated_section.dart';
part 'widget/items_list.dart';
part 'widget/search_field.dart';
part 'widget/overlay_builder.dart';
...
class IMultiSelectDropdown<T> extends StatefulWidget {
  ...
  IMultiSelectDropdown.multiSelect({
    super.key,
    required this.items,
  ...
  IMultiSelectDropdown.multiSelectSearch({
    super.key,
    required this.items,
    required this.onListChanged,
    this.initialItems,
  ...
  @override
  State<IMultiSelectDropdown> createState() => _IMultiSelectDropdownState<T>();
}

class _IMultiSelectDropdownState<T> extends State<IMultiSelectDropdown<T>> {
  ...
  @override
  void didUpdateWidget(covariant IMultiSelectDropdown<T> oldWidget) {
